...
class Eezy_Note_Block_Adminhtml_Tag_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
	protected function _prepareForm() {
		...
		$fieldset -> addField('name', 'text', array('label' => Mage::helper('note') -> __('Name'), 'class' => 'required-entry', 'required' => true, 'name' => 'name', ));

		$fieldset -> addField('key_url', 'text', array('label' => Mage::helper('note') -> __('Key URL'), 'class' => 'required-entry', 'required' => true, 'name' => 'key_url', ));
		...
		$fieldset -> addField('parent_id', 'select', array('size' => 5, 'label' => Mage::helper('note') -> __('Parent'), 'name' => 'parent_id', 'values' => Mage::getSingleton('note/tag') -> getTree()));

		$fieldset -> addField('short_description', 'editor', array('name' => 'short_description', 'label' => Mage::helper('note') -> __('Content'), 'title' => Mage::helper('note') -> __('Content'), 'style' => 'width:98%; height:200px;', 'wysiwyg' => false, 'required' => true, ));
